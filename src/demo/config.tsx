...
const { FieldSelect, FieldDropdown, FieldCascader, FieldTreeSelect } = AntdWidgets
    ...
    fieldSettings: {
      ...
      listValues: [
        ...
        },
        {
          ...
          children: [
            { value: "5", title: "Green" },
            { value: "6", title: "Blue", children: [{ value: "7", title: "Sub blue", children: [{ value: "8", title: "Sub sub blue and a long text" }] }] }
          ]
        }
      ]
    }
